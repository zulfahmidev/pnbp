    ...
    <div id="app">
        <div class="container my-5 p-5 bg-white rounded shadow-lg">
            ...
            <div class="row" id="header">
                <div class="col-lg-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" v-model="webData.c2_title" placeholder="Type here..." id="c2_title">
                    </div>
                    <div class="form-group mb-3">
                        <label for="c2_subtitle">Deskripsi: </label>
                        <input type="text" class="form-control" v-model="webData.c2_subtitle" placeholder="Type here..." id="c2_subtitle">
                    </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(d,i) in reverse(webData.c2_data)" :key="i">
                        <th>{{ d.label }}</th>
                        <td style="text-align: right;">{{ d.target }}</td>
                        <td style="text-align: right;">{{ d.realisasi }}</td>
                        <td style="text-align: right;">
                            <button type="button" @click="hapus(webData.c2_data.length-i-1)" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                            <button @click="edit(webData.c2_data.length-i-1)" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></button>
                        </td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
                        <td colspan="2" style="text-align: right;">Total: {{ total(webData.c2_data, 'target') }}</td>
                        <td style="text-align: right;">Total: {{ total(webData.c2_data, 'realisasi') }}</td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="modal fade" id="modalTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Modal Tambah" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label for="label">Uraian Akun</label>
        ...
        new Vue({
            ...
            methods: {
                ...
                edit(index) {
                    ...
                    let data = this.webData.c2_data[index];
                ...
                ubah() {
                    ...
                    if (conf) {
                        this.webData.c2_data[this.indexEdit].label = this.label;
                        this.webData.c2_data[this.indexEdit].target = parseInt(this.target);
                        this.webData.c2_data[this.indexEdit].realisasi = parseInt(this.realisasi);
                        this.label = '';
                        this.target = '';
                        this.realisasi = 0;
                        this.save();
                ...
                hapus(index) {
                    ...
                    if (conf) {
                        this.webData.c2_data.splice(index,1);
                        this.save();
                    }
                },
                reverse(arr) {
